...
- **MIT mail:** tailnet-only, implicit-TLS IMAP proxy plus Graph-backed SMTP bridge translate local LOGIN authentication to delegated Microsoft 365 OAuth2; Tailscale certificates renew automatically
