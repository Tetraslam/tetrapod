...
sudo mkdir -p /opt/tetrapod/{authelia/{data,redis,secrets},caddy/{data,config},jellyfin/config,jellyfin/cache,seerr,qbittorrent,prowlarr,sonarr,radarr,bazarr,pinchflat,suwayomi} /opt/tetrapod/{zipline/{uploads,public,db},shlink,media-reconcile}
